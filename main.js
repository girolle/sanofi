...
texts = [["Добро пожаловать в игру! Мы, Санофи, один из крупнейших производителей лекарственных средств в мире. Насколько хорошо вы представляете, как устроен процесс создания препаратов? Проверьте себя!"], 
[
...
[
	"Какие виды доклинических исследований существуют? (выберите 1 вариант ответа)", 
...
[
	...
	"Если препарат зарегистрирован в FDA (Food and Drug Administration) в США, ему не требуется дополнительная регистрация для реализации в РФ.",
...
[
	"Предположим, что вы создали рецептурный препарат. Пришло время выводить его на рынок. Что из перечисленного запрещено делать для продвижения такого препарата в России? (выберите 1 вариант ответа)",
...
[
	1, 
	"Правильно! Изучение аномальных изменений в организме на биохимическом и клеточном уровне позволяет в дальнейшем разработать химические соединения, способные специфичным образом предотвратить или скорректировать такого рода аномальные изменения", 
	"Неправильно! Утверждение программы клинических исследований на людях происходит только после успешного завершения исследования на лабораторных животных, а поиск перспективных молекул для нового препарата начинается с  изучения аномальных изменений в организме на биохимическом и клеточном уровне, вызываемых конкретным заболеванием"
],
[
	4, 
	"Неправильно! Компьютерное моделирование действительно является частью доклинических исследований: например, с его помощью можно спрогнозировать токсичность препарата. Но это не единственный вид: важны также исследования in vitro и in vivo. ", 
	'Неправильно! Исследование в лабораторных условиях ("в пробирке") действительно является частью доклинических исследований. Но это не единственный вид: важны также компьютерное моделирование и исследование in vivo.',
	"Неправильно! Эксперименты на живых организмах - это значимая часть доклинических исследований. Но это не единственный вид: важны также компьютерное моделирование и исследование in vitro.",
	'Правильно! Исследования в рамках доклинических разработок проводятся во всех перечисленных видах (компьютерное моделирование, исследования "in vitro" и "in vivo")'
],
[
	2, 
...
[
	1, 
	"Правильно! Реклама в СМИ (ТВ, радио и др.) запрещена в России, но в некоторых других старанах можно увидеть рекламу рецептурных препаратов на телевидении. Несмотря на это, производитель может принимать меры по повышению осведомленности о самом заболевании среди потенциальных потребителей, а также доносить информацию о конкретном препарате до врачей через медицинских представителей или на специализированных мероприятиях.",
	"Неправильно! Производитель может принимать меры по повышению осведомленности о самом заболевании среди потенциальных потребителей, а также доносить информацию о конкретном препарате до врачей через медицинских представителей или на специализированных мероприятиях, но реклама в СМИ (ТВ, радио и др.) запрещена в России. В некоторых других старанах можно увидеть рекламу рецептурных препаратов на телевидении.",
	"Неправильно! Производитель может принимать меры по повышению осведомленности о самом заболевании среди потенциальных потребителей, а также доносить информацию о конкретном препарате до врачей через медицинских представителей или на специализированных мероприятиях, но реклама в СМИ (ТВ, радио и др.) запрещена в России. В некоторых других старанах можно увидеть рекламу рецептурных препаратов на телевидении.",
	"Неправильно! Производитель может принимать меры по повышению осведомленности о самом заболевании среди потенциальных потребителей, а также доносить информацию о конкретном препарате до врачей через медицинских представителей или на специализированных мероприятиях, но реклама в СМИ (ТВ, радио и др.) запрещена в России. В некоторых других старанах можно увидеть рекламу рецептурных препаратов на телевидении."
],
[
